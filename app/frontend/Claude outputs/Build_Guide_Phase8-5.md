...
P8-2 (Colour system), P8-3 (Uniform themed scrollbars), P8-4 (Depth ladder
two-pane scroll layout), P8-5 (Blotter sizing), and P8-6 (FIX annotation
cleanup) complete and green; P8-7 (Assembly and acceptance) not started.
